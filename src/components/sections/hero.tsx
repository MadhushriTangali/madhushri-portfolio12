...
export function HeroSection() {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative gradient-subtle">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-slide-in-right">
            <Button size="xl" variant="hero" onClick={() => scrollToSection('#projects')} className="w-full sm:w-auto">
              View Portfolio
            </Button>
            <Button size="xl" variant="outline" onClick={() => scrollToSection('#contact')} className="w-full sm:w-auto">
              Get In Touch
            </Button>
          </div>
          ...
          <div className="flex justify-center space-x-6 mb-12 animate-fade-in">
            ...
            <a href="https://linkedin.com/in/madhushri-tangali" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-smooth hover:scale-110" aria-label="LinkedIn">
              <Linkedin className="h-6 w-6" />
            </a>
          </div>

          {/* Scroll Indicator */}
          <button onClick={() => scrollToSection('#about')} className="animate-bounce hover:text-primary transition-smooth" aria-label="Scroll to about section">
